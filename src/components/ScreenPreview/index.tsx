import { Layer, TransformScreenType } from "@/type/screen";
import { isComponent, isContainer, isPanel, isRef, isGroup } from '@/utils/index';
import React from "react";
const GroupWrap = React.lazy(() => import('./components/GroupWrap'));
const ComponentWrap = React.lazy(() => import('./components/ComponentWrap'));
