        ...
        <div className='p-[20px] h-full'>
            ...
            <div className='h-[calc(100%-40px)] overflow-y-auto pb-[20px]'>
                <div className="grid-cols-[repeat(auto-fill,minmax(258px,1fr))] grid gap-[24px] scroll-smooth">
                    <Item data={data} loading={loading} manage={manage} setCheckeds={setCheckeds} checkeds={checkeds} ></Item>
                </div>
            </div>
        </div>
    )
...
function Item({ data, loading, manage, setCheckeds, checkeds }: { data?: any[]; loading: boolean; manage: boolean; setCheckeds: (x: any) => any; checkeds: number[] }) {
